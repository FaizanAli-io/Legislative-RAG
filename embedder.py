...
class EmbeddingService:
    ...
    async def embed_chunks(self, chunks: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        for i in range(0, total_chunks, self.batch_size):
            ...
            logger.info(
                f"Processing batch {i//self.batch_size + 1}/{(total_chunks + self.batch_size - 1)//self.batch_size}"
            )
        ...
        logger.info(
            f"Embedding completed: {successful_embeddings}/{total_chunks} successful"
        )
